::: {#page .hfeed .site}
[Saltar al
contenido](../../../../../index.html?p=140#content){.skip-link
.screen-reader-text}
...
Ubuntu en lata {#ubuntu-en-lata .entry-title}
==============
...
::: {#dsq-content}
-   ::: {#dsq-comment-136}
    ::: {#dsq-comment-header-136 .dsq-comment-header}
    [Sandel]{#dsq-author-user-136}
    :::

    ::: {#dsq-comment-body-136 .dsq-comment-body}
    ::: {#dsq-comment-message-136 .dsq-comment-message}
    También descubrí que\
    [Ubuntu](http://sandel.tumblr.com/post/53605344/ubuntu-y-the-rones-no-tome-cualquier-cosa-vac-e)\
    era algo más que un sistema operativo. La probé y no me pareció tan
    amla aunque dudo que la compre algun día. Eso sí, la lata la tengo
    encima del escritorio de mi oficina.
    :::
    :::
    :::
:::
...
siguiente:]{.screen-reader-text} [¿Quieres descubrir la vida cultural de
