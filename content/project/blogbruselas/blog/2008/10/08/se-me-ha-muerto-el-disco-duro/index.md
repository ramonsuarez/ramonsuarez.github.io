::: {#page .hfeed .site}
[Saltar al
contenido](../../../../../index.html?p=164#content){.skip-link
.screen-reader-text}
...
Se me ha muerto el disco duro {#se-me-ha-muerto-el-disco-duro .entry-title}
=============================
...
::: {#dsq-content}
-   ::: {#dsq-comment-1046}
    ::: {#dsq-comment-header-1046 .dsq-comment-header}
    [María]{#dsq-author-user-1046}
    :::

    ::: {#dsq-comment-body-1046 .dsq-comment-body}
    ::: {#dsq-comment-message-1046 .dsq-comment-message}
    Hola Rámón,

    Espero que tengas suerte con la recuperación de tus datos, si no es
    así, déjalo en manos de expertos, conozco a unos chicos de madrid
    que tienen una empresa de recuperación de datos, se llaman
    OnRetrieval y son bastante buenos.
    :::
    :::
    :::
:::
...
anterior:]{.screen-reader-text} [Nuevo feed: actualiza tu lector de
blogs]{.post-title}](../../../../../index.html?p=163)
:::

::: {.nav-next}
[[Siguiente]{.meta-nav aria-hidden="true"} [Entrada
siguiente:]{.screen-reader-text} [Ordenadores y piezas, nuevos y de
