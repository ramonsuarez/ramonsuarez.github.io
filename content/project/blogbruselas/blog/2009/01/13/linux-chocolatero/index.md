::: {#page .hfeed .site}
[Saltar al
contenido](../../../../../index.html?p=222#content){.skip-link
.screen-reader-text}
...
Linux chocolatero {#linux-chocolatero .entry-title}
=================
...
::: {#dsq-content}
-   ::: {#dsq-comment-251}
    ::: {#dsq-comment-header-251 .dsq-comment-header}
    [Charlotte Harris]{#dsq-author-user-251}
    :::

    ::: {#dsq-comment-body-251 .dsq-comment-body}
    ::: {#dsq-comment-message-251 .dsq-comment-message}
    No me hables de chocolate con el hambre que tengo!!!!
    :::
    :::
    :::
:::
...
anterior:]{.screen-reader-text} [Pingüi-droide
belga]{.post-title}](../../../../../index.html?p=221)
:::

::: {.nav-next}
[[Siguiente]{.meta-nav aria-hidden="true"} [Entrada
siguiente:]{.screen-reader-text} [El Vaticano dice que Tintín no es
