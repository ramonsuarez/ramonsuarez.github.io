::: {#page .hfeed .site}
[Saltar al
contenido](../../../../../index.html?p=238#content){.skip-link
.screen-reader-text}
...
¿Otra huelga en la STIB? {#otra-huelga-en-la-stib .entry-title}
========================
...
::: {#dsq-content}
-   ::: {#dsq-comment-307}
    ::: {#dsq-comment-header-307 .dsq-comment-header}
    [Héctor]{#dsq-author-user-307}
    :::

    ::: {#dsq-comment-body-307 .dsq-comment-body}
    ::: {#dsq-comment-message-307 .dsq-comment-message}
    Hace 3 semanas ya hubo una de autobuses. Estos están de huelga toda
    la vida!\
    Primero deberian de aprender a conducir, porque son mas bruscos... y
    luego ya empezar a quejarse.\
    Talue!
    :::
    :::
    :::
...
anterior:]{.screen-reader-text} [Yes,
week-end]{.post-title}](../../../../../index.html?p=237)
:::

::: {.nav-next}
[[Siguiente]{.meta-nav aria-hidden="true"} [Entrada
siguiente:]{.screen-reader-text} [Gilipollismo viral en la Grand
Place]{.post-title}](../../../../../index.html?p=239)
:::
:::
:::
:::
