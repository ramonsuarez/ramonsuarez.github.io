::: {#page .hfeed .site}
[Saltar al
contenido](../../../../../index.html?p=244#content){.skip-link
.screen-reader-text}
...
Elegid el día que os venga mejor para la quedada en Bruselas {#elegid-el-día-que-os-venga-mejor-para-la-quedada-en-bruselas .entry-title}
============================================================
...
::: {#dsq-content}
-   ::: {#dsq-comment-345}
    ::: {#dsq-comment-header-345 .dsq-comment-header}
    [Comer, hablar, amar]{#dsq-author-user-345}
    :::

    ::: {#dsq-comment-body-345 .dsq-comment-body}
    ::: {#dsq-comment-message-345 .dsq-comment-message}
    El resultado de la encuesta: [gran quedada el 14 de
...
anterior:]{.screen-reader-text} [¿Gran quedada
bloggero-bruselo-hispano-belga?]{.post-title}](../../../../../index.html?p=243)
:::

::: {.nav-next}
[[Siguiente]{.meta-nav aria-hidden="true"} [Entrada
siguiente:]{.screen-reader-text} [Enjuto y el
