::: {#page .hfeed .site}
[Saltar al
contenido](../../../../../index.html?p=262#content){.skip-link
.screen-reader-text}
...
Poco: el español rácano de la Región de Bruselas {#poco-el-español-rácano-de-la-región-de-bruselas .entry-title}
================================================
...
::: {#dsq-content}
-   ::: {#dsq-comment-413}
    ::: {#dsq-comment-header-413 .dsq-comment-header}
    [Comer, hablar, amar; vivir al fin y al cabo]{#dsq-author-user-413}
    :::

    ::: {#dsq-comment-body-413 .dsq-comment-body}
    ::: {#dsq-comment-message-413 .dsq-comment-message}
    Buf... esto de los recortables es más complicado de lo que creía. Me
    ha quedado Poco un mucho chuchurrío...
    :::
    :::
    :::
:::
...
anterior:]{.screen-reader-text} [Receta: cocido
bruseleño]{.post-title}](../../../../../index.html?p=261)
:::

::: {.nav-next}
[[Siguiente]{.meta-nav aria-hidden="true"} [Entrada
siguiente:]{.screen-reader-text} [Quedada y blogs en
