::: {#page .hfeed .site}
[Saltar al
contenido](../../../../../index.html?p=722#content){.skip-link
.screen-reader-text}
...
La Prohibida en Bruselas {#la-prohibida-en-bruselas .entry-title}
========================
...
[travesti](../../../../tag/travesti/index.html)]{.tags-links}

::: {#disqus_thread}
::: {#dsq-content}
-   Pingback: [Tweets that mention La Prohibida en Bruselas - Blog
    Bruselas: comer, hablar y amar en la capital de Europa \--
    Topsy.com](http://topsy.com/tb/ow.ly/15TarD){.url}()

-   ::: {#dsq-comment-908}
    ::: {#dsq-comment-header-908 .dsq-comment-header}
    [PabloElFlamenco](http://pabloelflamenco.blogspot.com/){#dsq-author-user-908}
    :::

    ::: {#dsq-comment-body-908 .dsq-comment-body}
    ::: {#dsq-comment-message-908 .dsq-comment-message}
    Estoy, y me quedó ... ¡mudo!\
    (sussurra mí angelito ..."majór así, Pablocito, es cosa de, ahem,
    Españoles"...)
    :::
    :::
    :::
...
anterior:]{.screen-reader-text} [EBE09: el enlace España
Europa]{.post-title}](../../../../../index.html?p=711)
:::

::: {.nav-next}
[[Siguiente]{.meta-nav aria-hidden="true"} [Entrada
siguiente:]{.screen-reader-text} [Hotel Conrad: ¿cambio de
clientela?]{.post-title}](../../../../../index.html?p=731)
:::
:::
:::
:::
