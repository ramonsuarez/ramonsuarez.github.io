::: {#page .hfeed .site}
[Saltar al
contenido](../../../../../index.html?p=1650#content){.skip-link
.screen-reader-text}
...
Restaurante Volver: este logo me dice algo {#restaurante-volver-este-logo-me-dice-algo .entry-title}
==========================================
...
[volver
Bruselas](../../../../tag/volver-bruselas/index.html)]{.tags-links}

::: {#disqus_thread}
::: {#dsq-content}
-   ::: {#dsq-comment-1257}
    ::: {#dsq-comment-header-1257 .dsq-comment-header}
    [Alvaro]{#dsq-author-user-1257}
    :::

    ::: {#dsq-comment-body-1257 .dsq-comment-body}
    ::: {#dsq-comment-message-1257 .dsq-comment-message}
    Cuando leí el titulo de la entrada, el nombre me sugirió otra cosa:
    un tango. A edades diferentes...\
    Pero supongo que va más por Almodovar como tu dices. Los colores de
    las letritas reenvian, en el imaginario belga al menos, a nuestro
    famoso director.
    :::
    :::
    :::
...
-   ::: {#dsq-comment-1259}
    ::: {#dsq-comment-header-1259 .dsq-comment-header}
    [Ramón
    Suárez](http://twitter.com/ramonsuarez){#dsq-author-user-1259}
    :::

    ::: {#dsq-comment-body-1259 .dsq-comment-body}
    ::: {#dsq-comment-message-1259 .dsq-comment-message}
    Mejor [por
    bulerías](http://www.youtube.com/watch#!videos=igH8VGPP1PQ&v=26wv33D4ymQ).
    ¡Chano que grande eres!
    :::
    :::
    :::
:::
...
anterior:]{.screen-reader-text} [El huevo de
Albert]{.post-title}](../../../../../index.html?p=1636)
:::

::: {.nav-next}
[[Siguiente]{.meta-nav aria-hidden="true"} [Entrada
siguiente:]{.screen-reader-text} [Viejos tiempos: hombres de verdad,
