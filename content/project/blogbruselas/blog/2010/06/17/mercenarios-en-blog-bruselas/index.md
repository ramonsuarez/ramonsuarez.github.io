::: {#page .hfeed .site}
[Saltar al
contenido](../../../../../index.html?p=2247#content){.skip-link
.screen-reader-text}
...
¡Mercenarios en Blog Bruselas! {#mercenarios-en-blog-bruselas .entry-title}
==============================
...
[mercenarios en Blog
Bruselas](../../../../tag/mercenarios-en-blog-bruselas/index.html)]{.tags-links}

::: {#disqus_thread}
::: {#dsq-content}
-   ::: {#dsq-comment-1514}
    ::: {#dsq-comment-header-1514 .dsq-comment-header}
    [Javier](http://www.bernalrevert.com/blog){#dsq-author-user-1514}
    :::

    ::: {#dsq-comment-body-1514 .dsq-comment-body}
    ::: {#dsq-comment-message-1514 .dsq-comment-message}
    jajaja vaya por Dios, ya nos han descubierto.

    Por cierto, ¡gracias por la mención de hoy!
    :::
    :::
    :::
:::
...
anterior:]{.screen-reader-text} [Día del español futbolero y embrujado,
la semana en Hispagenda]{.post-title}](../../../../../index.html?p=2240)
:::

::: {.nav-next}
[[Siguiente]{.meta-nav aria-hidden="true"} [Entrada
siguiente:]{.screen-reader-text} [Fotógrafos españoles en Bruselas:
