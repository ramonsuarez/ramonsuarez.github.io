::: {#page .hfeed .site}
[Saltar al
contenido](../../../../../index.html?p=3198#content){.skip-link
.screen-reader-text}
...
Todos vós sodes capitáns (Oliver Laxe, 2010) {#todos-vós-sodes-capitáns-oliver-laxe-2010 .entry-title}
============================================
...
laxe](../../../../tag/oliver-laxe/index.html)]{.tags-links}

::: {#disqus_thread}
::: {#dsq-content}
-   ::: {#dsq-comment-1877}
    ::: {#dsq-comment-header-1877 .dsq-comment-header}
    [David Asenjo](http://www.centrogalego.be){#dsq-author-user-1877}
    :::

    ::: {#dsq-comment-body-1877 .dsq-comment-body}
    ::: {#dsq-comment-message-1877 .dsq-comment-message}
    Además de proyectarse "Todos vós sodes capitáns", su director Oliver
    Laxe estará presente y mantendrá un coloquio con los espectadores.
    :::
    :::
    :::
:::
...
anterior:]{.screen-reader-text} [Ahora para iPhone, Android y
Blackberry]{.post-title}](../../../../../index.html?p=3195)
:::

::: {.nav-next}
[[Siguiente]{.meta-nav aria-hidden="true"} [Entrada
siguiente:]{.screen-reader-text} [Estáis invitados a la inauguración de
